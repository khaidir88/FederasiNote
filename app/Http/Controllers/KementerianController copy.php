...
class KementerianController extends Controller
{
    ...
    /**
     * Menampilkan detail dinas berdasarkan slug dengan daftar agenda
     */
    // public function showdinas($slug)
    // {
    //     $dinas = Dinas::where('slug', $slug)
    //         ->with(['agendas' => function ($query) {
    //             $query->latest()->paginate(10); // Paginasi agenda per dinas
    //         }])
    //         ->firstOrFail();
    ...
    //     return view('kementerian.dinas', compact('dinas', 'otherDinas'));
    // }
    public function showdinas($slug)
    {
    ...
    //     // Agenda terkait dari dinas yang sama
    //     $relatedAgendas = Agenda::where('dinas_id', $agenda->dinas_id)
    //         ->where('id', '!=', $agenda->id)
    //         ->latest()
    //         ->take(3)
    //         ->get();
    ...
    // public function details($slug)
    // {
    //     $agenda = Agenda::with('dinas.agendas')
    //         ->where('slug', $slug)
    //         ->firstOrFail();

    //     return view('kementerian.agenda-details', compact('agenda'));
    // }
    /**
