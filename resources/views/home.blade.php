                                        ...
                                        <div class="hero-caption position-absolute bottom-0 mb-0 start-0 w-100 text-white p-4">
                                            <div class="mb-2">
                                                ...
                                                <span class="badge me-2 px-2 py-1"
                                                    style="background-color: {{ $article->category->color }}; color: #fff; font-size: 0.7rem; letter-spacing: 0;">
                                                    {{ strtoupper(Str::limit($article->category->name, 12)) }}
                                                </span>
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('news.show',$article->slug) }}" class="text-decoration-none">
                                    <div class="poster-card">
                                        <img src="{{ asset('public/../images/articles/'.$article->image) }}" alt="{{ $article->title }}">
            ...
            <div class="col-md-8">
                ...
                <div class="card mb-4">
                    ...
                    <a href="{{ route('news.show', $featuredArticle->slug) }}">
                        <img src="{{ asset('public/../images/articles/'.$featuredArticle->image) }}"
                            class="card-img-top"
