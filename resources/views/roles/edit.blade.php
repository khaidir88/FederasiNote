            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('roles.update', $roles->id) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="my-3">
                            <label class="text-lg font-medium" for="name">Role</label>
                            <input
                                value="{{ old('name', $roles->name) }}"
                                placeholder="Masukkan Roles Anda"
                                name="name"
                                type="text"
                        ...
                        <div class="d-flex justify-content-end align-items-center me-5 py-5">
                            <a href="{{ route('roles.index') }}" class="btn btn-outline-secondary me-2">
                                <i class="bi bi-x-circle me-1"></i>Batal
                            </a>
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                <i class="bi bi-check-circle me-1"></i>Update Roles
                            </button>
                        </div>
