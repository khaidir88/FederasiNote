...
<div class="container py-5">
            ...
            <form method="GET">
                <div class="input-group shadow-sm">
                    ...
                    <input type="text"
                        ...
                        class="form-control"
                        placeholder="Cari nama kementerian, struktur, atau keterangan...">
    ...
    <div class="card shadow border-0 rounded-0">
        <div class="card-body table-responsive">
            <table class="table table-hover align-middle text-center" id="dinasTable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            {{-- Jika paginate → pakai firstItem --}}
                            {{-- Jika search (Collection) → urut manual --}}
                            {{ $dinass instanceof \Illuminate\Support\Collection
                                ? $index + 1
                                : $dinass->firstItem() + $index }}
                        </td>
        ...
        <div class="d-flex justify-content-center mt-4 custom-pagination">
            @if(!$dinass instanceof \Illuminate\Support\Collection)
            <nav>
...
@push('scripts')
<script>
    // Live Search dengan Clear Button
    ...
    function performSearch() {
        ...
        // Tampilkan/tutup tombol clear berdasarkan apakah ada input
    ...
    // Sembunyikan tombol clear saat halaman pertama kali dimuat
