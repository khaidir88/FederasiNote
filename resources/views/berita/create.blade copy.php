...
<script>
    document.addEventListener("DOMContentLoaded", function() {
            ...
            if (type === "video") {
                ...
                <div class="content-item border rounded p-3 mb-3 bg-light">
                    ...
                    <div class="text-center mb-3">
                        <video class="video-preview rounded border d-none w-100" controls style="background:#000; margin: 0 auto; display: block;"></video>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <!-- Lebar Slider (Langsung Menyimpan ke Form Name) -->
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
                        ...
                        <!-- Radius Slider (Langsung Menyimpan ke Form Name) -->
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">
        ...
        // Event Slider Listener (Lebar dan Radius)
